...
use Cline\Toggl\GroupRepositories\ArrayGroupMembershipRepository;
...
describe('Decorator', function (): void {
    ...
    describe('Sad Path', function (): void {
        test('stored throws exception when driver does not support listing', function (): void {
            ...
            $decorator = new Decorator(
                ...
                new ArrayGroupMembershipRepository($manager),
            );
    ...
    describe('Edge Cases', function (): void {
        ...
        test('checkFeatureViaGroupMembership handles exception when group does not exist', function (): void {
            // Arrange
            $decorator = createDecorator();
            ...
            // This simulates the edge case where group membership is stale
        ...
        test('checkFeatureViaGroupMembership returns group value when feature is in group', function (): void {
            // Arrange
            $decorator = createDecorator();
            ...
            // Act - Should check group membership and return true
        ...
        test('checkFeatureViaGroupMembership continues on exception and checks remaining groups', function (): void {
            // Arrange
            $decorator = createDecorator();
        ...
        test('assign and unassign group membership integration', function (): void {
            // Arrange
            $decorator = createDecorator();
            ...
            // Also test that group membership is correctly identified
        ...
        test('checkFeatureViaGroupMembership returns false when group value is false', function (): void {
            // Arrange
            $decorator = createDecorator();
            ...
            // Act - Should check group membership but feature is not active globally
        ...
        test('checkFeatureViaGroupMembership returns false when group value is null', function (): void {
            // Arrange
            $decorator = createDecorator();
