...
final class GroupMembership extends Model
{
     ...
     *
     * Retrieves the group memberships table name from the Toggl configuration,
     * defaulting to 'group_memberships' if not configured.
     *
     * @return string The table name for group membership storage
     */
    #[Override()]
    public function getTable(): string
    {
        $table = Config::get('toggl.table_names.group_memberships', 'group_memberships');
