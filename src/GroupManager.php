...
/**
 * Central manager for feature groups and group memberships.
 *
 * Provides a fluent API for defining, updating, and managing feature groups
 * along with context-to-group membership operations. Combines both group
...
final readonly class GroupManager
{
     ...
     * @param GroupMembershipRepository $membershipRepository Repository implementation for managing group memberships
