...
/**
 * Context-focused fluent interface for group membership operations.
 *
 * Provides a natural API for managing group memberships from the perspective
...
final readonly class GroupManagerForContext
{
    ...
    /**
     * Add this context to a group membership.
     *
    ...
    /**
     * Remove this context from a group membership.
     *
