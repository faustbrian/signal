 ...
 *
 * Group memberships enable context-based feature activation by associating contexts
 ...
 * - A/B testing where cohorts are represented as group memberships
 *
...
interface GroupMembershipRepository
{
    ...
    /**
     * Add multiple contexts to a group membership efficiently.
     *
    ...
    /**
     * Remove multiple contexts from a group membership efficiently.
     *
     ...
     * interfaces).
     *
     * Useful for auditing group membership, displaying lists of users with access
     ...
     *
     * @param  TogglContext       $context Context to check group memberships for
