...
use Cline\Toggl\Contracts\GroupMembershipRepository;
...
/**
 * Database-backed group membership repository for persistent storage.
 *
 * Stores group memberships in the database using polymorphic relationships,
 * enabling persistence across requests. Uses the group_memberships table with
 ...
 */
#[Singleton()]
final readonly class DatabaseGroupMembershipRepository implements GroupMembershipRepository
{
    /**
     * Add a context to a group membership.
     *
    ...
    /**
     * Add multiple contexts to a group membership.
     *
    ...
    /**
     * Remove a context from a group membership.
     *
    ...
    /**
     * Remove multiple contexts from a group membership.
     *
    ...
    /**
     * Remove a context from all group memberships.
     *
    ...
    /**
     * Create a new query builder for the GroupMembership model.
     *
     * Configures the connection based on toggl.default and toggl.stores configuration.
     *
     * @return Builder<GroupMembership> Eloquent query builder instance
     */
    private function newQuery(): Builder
    {
        $query = QueryBuilder::groupMembership();
